...
def ip(O000OO0O0O000OOO0) -> bool:
    ...
    while OO0OOO0000O000O00 * OO0OOO0000O000O00 <= O000OO0O0O000OOO0:
        if (
            O000OO0O0O000OOO0 % OO0OOO0000O000O00 == 0
            or O000OO0O0O000OOO0 % (OO0OOO0000O000O00 + 2) == 0
        ):
            return False
...
def f(request):
    ...
    OO00O00OOOO000OOO = {
        homework.ODD: lambda O0OO0O00O0OOO00OO: O0OO0O00O0OOO00OO % 2 != 0,
        homework.EVEN: lambda OO0000OO0OO00OO00: OO0000OO0OO00OO00 % 2 == 0,
        homework.PRIME: ip,
    }
...
@pytest.mark.parametrize(
    "f", [homework.ODD, homework.EVEN, homework.PRIME], indirect=True
)
